...
import com.youkang.common.exception.file.FileNameLengthLimitExceededException;
import com.youkang.common.exception.file.FileSizeLimitExceededException;
import com.youkang.common.exception.file.InvalidExtensionException;
...
import com.youkang.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = YouKangConfig.getProfile();
    ...
    {
        int dirLastIndex = YouKangConfig.getProfile().length() + 1;
